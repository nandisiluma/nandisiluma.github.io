        ...
        <div class="row no-gutters">
          ...
          <div class="col-xl-7 ps-0 ps-lg-5 pe-lg-1 d-flex align-items-stretch">
            <div class="content d-flex flex-column justify-content-center">
              <h3>Junior Computer Science student at Northwestern University</h3>
              <p>
                I have taken courses in Data Structure and Algorithms, Functional Programming and Linear Algebra. I am passionate about building products that add value to our society, products with a social impact.
              </p>
              <div class="row">
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <p><strong>User based-</strong> worked on two projects that involved workign with a client, a direct user of our end product. Colorstack, DTC1 AND 2 </p>
                  </div>
                </div>
                ...
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <span data-purecounter-start="0" data-purecounter-end="2" data-purecounter-duration="1" class="purecounter"></span>
                    <p><strong>Summer experience</strong> Worked with two different organizations, a Research Lab and an externship program</p>
                  </div>
                </div>
                ...
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <p><strong>Extracurrcilular</strong> Emzini weCode, LCMNU and ColorStack</p>
                  </div>
                </div>
                ...
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <p><strong>Accomplishments</strong> Summary of lessons learnt and goals achieved in all projects</p>
                  </div>
                </div>
              </div>
            </div><!-- End .content-->
    ...
    <section id="skills" class="skills section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Skills</h2>
          <p>These are the skills I have acquired and my proficiency in each of them </p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="resume-item">
              ...
              <p>Say something about my college years and experiences so far</p>
            </div>
            <div class="resume-item">
